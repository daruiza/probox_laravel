...
class OptionRolController extends Controller
{
    ...
    /**
     * @OA\Get(
     *      path="/optionrol/showoptionrolbyrolid/{id_rol}",
     *      operationId="getOptionRolByRolId",
     *      tags={"OptionRol"},
     *      summary="Get One OptionRol By one Id Rol",
     *      description="Return One OptionRol by Id Rol",
     *      security={ {"bearer": {} }},
     *      @OA\Parameter(
     *          name="id_rol",
     *          description="OptionRol by Id Rol",
     *          required=true,
     *          in="path",
     *          @OA\Schema(
     *              type="integer"
     ...
     *     )
     */
    public function showOptionRolByRolId(Request $request, $id_rol)
    {
        return $this->OptionRolQuery->showOptionRolByRolId($request, $id_rol);
    }

     /**
     * @OA\Get(
     *      path="/optionrol/showoptionrolbyoptionid/{id_option}",
     *      operationId="getOptionRolByOptionId",
     *      tags={"OptionRol"},
     *      summary="Get One OptionRol By one Id Option",
     *      description="Return One OptionRol by Id Option",
     *      security={ {"bearer": {} }},
     *      @OA\Parameter(
     *          name="id_option",
     *          description="OptionRol by Id Option",
     *          required=true,
     *          in="path",
     *          @OA\Schema(
     *              type="integer"
     ...
     *     )
     */
    public function showOptionRolByOptionId(Request $request, $id_option)
    {
        return $this->OptionRolQuery->showOptionRolByOptionId($request, $id_option);
    }
